...
"""Run script from fDer. Reads all toc files in the *reprt* fDer
and writes the toc PDF to the same fDer.
...
def writepdf(list2, path2):
    ...
    try:
        pdf1 = "latexmk -xelatex -quiet -f " + os.path.join(
            path2, "reporttoc.tex"
        )
        print("< pdf table of contents written to reprt fDer >")
        os.system(pdf1)
    except:
        print("< pdf table of contents not written to reprt fDer >")
