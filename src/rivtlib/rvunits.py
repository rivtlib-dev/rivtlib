...
# area
m2 = new_unit("m2", (m**2), "square meter")
mm2 = new_unit("mm2", (mm**2), "square millimeter")
cm2 = new_unit("cm2", (cm**2), "square centimeter")
# volume
cm3 = new_unit("cm3", (cm**3), "cubic centimeter")
cm4 = new_unit("cm4", (cm**4), "cm to fourth power")
# density
kg_m3 = new_unit("kg_m3", KG / (M**3), "kilogram per cubic meter")
...
# density
k_ci = new_unit("k_ci", kips / inch**3, "pounds per cubic inch")
