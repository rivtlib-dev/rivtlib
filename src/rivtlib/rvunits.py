...
k_in = new_unit("k_i", kips / inch, "kips per inch")
k_ft = new_unit("k_ft", kips / ft, "kips per foot")
lb_in = new_unit("lb_in", lbf / inch, "pounds per inch")
lb_ft = new_unit("lb_ft", lbf / ft, "pounds per foot")
# area
...
psin = lb_in2 = new_unit("lb_in2", lbf / inch**2, "pounds per square inch")
